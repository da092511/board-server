...
<body>
	...
	<section id="root">
		<h2>회원 정보 수정</h2>
		<form method="POST" action="/updateUserForm">
			<div>
				<input type="text" id="id" name="id" value="${user.id}" disabled>
				<input type="password" id="password" name="password" placeholder="비밀번호">
				<input type="password" id="password" name="password-new" placeholder="새로운 비밀번호">
			...
			<div class="error-container">
				...
				<p class="error-msg" id="error-msg-birth-pattern">* 생년월일: 8자리를 입력하세요.</p>
				<p class="error-msg" id="error-msg-telecom">* 이메일: 이메일 주소가 정확한지 확인해 주세요.</p>
			...
			<div>
				...
				<div class="error-container">
					<p class="error-msg" id="error-msg-agree">* 약관동의: 필수 정보입니다.</p>
				</div>
			</div>
